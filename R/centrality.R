...
#' @param ... others arguments passed to \code{\link[igraph::degree]{igraph::degree()}}
#'
...
#'
#' @param graph an \code{igraph} object.
#' @param ... others arguments passed to \code{\link[igraph::closeness]{igraph::closeness()}}
#'
...
#' @param ... others arguments passed to \code{\link[igraph::betweeness]{igraph::betweenness()}}
#'
...
#'
#' @param graph an \code{igraph} object.
#' @param full \code{logical} should all the \code{igraph::eigen_centrality()} output be returned or only the scores?
#' @param ... others arguments passed to \code{\link[igraph::eigen_centrality]{igraph::eigen_centrality()}}
#'
#' @return \code{numeric} a vector containing eigenvector centrality coefficients for each node.
#' \code{list} see \code{\link[igraph::eigen_centrality]{igraph::eigen_centrality()}} documentation for more informations.
#' @export
#'
#' @examples
#' @references Delmas, E., Besson, M., Brice, M.-H., Burkle, L. A., Dalla Riva, G. V., Fortin, M.-J., … Poisot, T. (2019). Analysing ecological networks of species interactions. Biological Reviews.
